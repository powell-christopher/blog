...
{% codeblock Store setup lang:JavaScript %}
const store = createStore(commentsReducer);
{% endcodeblock %}

{% codeblock Provider setup lang:JavaScript %}
...
{% codeblock Using the store lang:JavaScript %}
...
{% codeblock Reducers lang:JavaScript %}
/**
  CommentReducers
...
{% codeblock Dispatching actions from CommentBox.js lang:JavaScript %}
